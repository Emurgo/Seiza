  ...
  return {
    totalAdaTransferred: () =>
      elastic
        ...
        .then(({ data }) =>
          prepareSeries(data, y => parseAdaValue(y).toNumber())
        ),
...
export default {
  Query: {
    generalInfo: (root: any, args: any, context: any) =>
      fetchGeneralInfo(context, args.infoPeriod),
    epochInfo: (root: any, args: any, context: any) =>
      fetchEpochInfo(context, args.epoch),
    slotInfo: (root: any, args: any, context: any) =>
      fetchSlotInfo(context, args.epoch, args.slot),
