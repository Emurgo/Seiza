...
export const MOCKED_STAKING_KEY_ACTIONS = [
  {
...
export const MOCKED_POOL_ACTIONS = [
  {
...
export const MOCKED_CERT_ACTIONS = [...MOCKED_STAKING_KEY_ACTIONS, ...MOCKED_POOL_ACTIONS]
