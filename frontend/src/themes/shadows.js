...
export const getShadowColors = (color) => [
  fade(color, shadowKeyUmbraOpacity),
  fade(color, shadowKeyPenumbraOpacity),
  fade(color, shadowAmbientShadowOpacity),
]

export function createShadow(baseColor, px) {
  const shadowColors = getShadowColors(baseColor)
  return [
...
export const defaultShadowsDefs = [
